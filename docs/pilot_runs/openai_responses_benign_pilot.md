...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `benign_summary` | `streaming` | `gpt-4.1-mini` | yes | 24 | 16 | 98 | 836.762 | 2497.404 | 0.008 | `complete` |
| `benign_summary` | `nonstreaming` | `gpt-4.1-mini` | yes | 6 | 0 | 98 | 1165.356 | n/a | 0.006 | `complete` |
| `long_text_generation` | `streaming` | `gpt-4.1-mini` | yes | 109 | 101 | 608 | 951.109 | 2140.552 | 0.012 | `complete` |
| `long_text_generation` | `nonstreaming` | `gpt-4.1-mini` | yes | 6 | 0 | 608 | 2844.857 | n/a | 0.005 | `complete` |
| `numbered_list_generation` | `streaming` | `gpt-4.1-mini` | yes | 136 | 128 | 729 | 840.616 | 1018.920 | 0.022 | `complete` |
| `numbered_list_generation` | `nonstreaming` | `gpt-4.1-mini` | yes | 6 | 0 | 707 | 3848.149 | n/a | 0.005 | `complete` |
| `short_text_generation` | `streaming` | `gpt-4.1-mini` | yes | 17 | 9 | 58 | 2324.892 | 3418.280 | 0.008 | `complete` |
| `short_text_generation` | `nonstreaming` | `gpt-4.1-mini` | yes | 6 | 0 | 58 | 1524.352 | n/a | 0.005 | `complete` |
| `structured_json_generation` | `streaming` | `gpt-4.1-mini` | yes | 50 | 42 | 165 | 1668.958 | 4359.041 | 0.007 | `complete` |
| `structured_json_generation` | `nonstreaming` | `gpt-4.1-mini` | yes | 6 | 0 | 165 | 2995.970 | n/a | 0.005 | `complete` |
